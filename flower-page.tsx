...
const FlowerPage: React.FC = () => {
  return (
    <>
      ...
      >
        <div id="thankyou" className={`w-full text-center mt-5 mb-[400px] z-[1000] relative ${monomakh.className}`}>
          <b className="text-5xl block mb-4">Thank you for being my girlfriend</b>
          <p className="text-2xl">I hope you will enjoy these flowers for Valentine</p>
        </div>
