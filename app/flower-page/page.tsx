...
const FlowerPage: React.FC = () => {
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-[#FFF5E4] flex flex-col items-center justify-start overflow-hidden text-[#FF9494] ${monomakh.className}`}
      >
        <div id="thankyou" className={`w-full text-center mt-8 md:mt-12 mb-[200px] md:mb-[400px] z-[1000] relative px-4 md:px-6 ${monomakh.className}`}>
          <b className="text-3xl md:text-5xl block mb-3 md:mb-4">Thank you for being my girlfriend</b>
          <p className="text-xl md:text-2xl">I hope you will enjoy these flowers</p>
        </div>
        <div className="flower scale-75 md:scale-100">
